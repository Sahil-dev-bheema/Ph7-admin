...
const menuItems = [
  ...
  { name: "Pools", path: "/pools", icon: <MdOutlinePostAdd className="h-6 w-6" /> },
  { name: "Packages", path: "/packages", icon: <TbPackages className="h-6 w-6" /> },
  { name: "Withdrawl", path: "/withdrawl", icon: <GiReceiveMoney className="h-6 w-6" /> },
];
